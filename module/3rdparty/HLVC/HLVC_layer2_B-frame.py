...
# parser.add_argument("--ref_1", default='f001.png')
# parser.add_argument("--ref_2", default='f011.png')
# parser.add_argument("--raw", default='f006.png')
# parser.add_argument("--com", default='f006.png')
# parser.add_argument("--bin", default='006.bin')
